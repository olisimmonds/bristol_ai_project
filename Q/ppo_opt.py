...
def test_agent(gamma, lam, clip_ratio, policy_learning_rate, value_function_learning_rate, target_kl):
    ...
    env = gym.make("LunarLander-v2") #Acrobot-v1 CartPole-v0
    ...
    for epoch in range(epochs):
        ...
        if epoch >= 30:
            results.append(sum_return / num_episodes)
        print(
...
end_results = []
for i in range(10):
    end_results.append(test_agent(0.9997, 0.97, 0.256313, 0.003, 0.001, 0.03))
    print('On iter ', i, ' results = ', end_results)


print('|||||')
print('|||||')
print('|||||')
print('results = ', end_results)
