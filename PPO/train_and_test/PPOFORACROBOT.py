...
def test_agent(gamma, lam, clip_ratio, policy_learning_rate, value_function_learning_rate, target_kl):
    ...
    env = gym.make("Acrobot-v1") #Acrobot-v1 CartPole-v0  MountainCar-v0
...
#     return loss
        ...
        # if epoch == 10 and sum_return / num_episodes < 350:
...
pbounds = {'gamma': (0.5, 0.99999), 'lam': (0.5,0.99999), 'clip_ratio': (0.1,0.3), 'policy_learning_rate' : (3e-5, 3e-3), 'value_function_learning_rate': (1e-4, 1e-2), 'target_kl': (0.001, 0.1)}
