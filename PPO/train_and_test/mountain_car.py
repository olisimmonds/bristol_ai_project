...
def test_agent(gamma, lam, clip_ratio, policy_learning_rate, value_function_learning_rate, target_kl):
    ...
    env = gym.make("MountainCar-v0") #, render_mode =  'human') #Acrobot-v1 CartPole-v0
...
def test_tuned():
    for i in range(10):
        ...
        all_episodes = test_agent(0.9997, 0.97, 0.256313, 0.003, 0.001, 0.03) # MC params
        # test_agent(0.843372894403312, 0.9599587339508671, 0.2293724995049937, 0.0011442691866330194, 0.0008844199196409004, 0.0768585945177951) cartpole params
         # test_agent(0.9692121, 0.95135, 0.271253, 0.00237, 0.000999205, 0.0076359) # testing acorbot params
